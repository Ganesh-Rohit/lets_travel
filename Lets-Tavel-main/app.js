...
let randomRouter = require('./routes/show-random');//router for random post
...
mongoose.connect('mongodb+srv://GaneshRohit:Rohit123@ganeshrohit123.jm18f.mongodb.net/travels',{useNewUrlParser:true } ); //connecting to database
